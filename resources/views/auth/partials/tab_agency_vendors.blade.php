    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <div class="panel-actions">
                {{-- Search --}}
                <form method="GET" action="{{ route('dashboard') }}" class="search-form" id="form-search-av">
                    <input type="hidden" name="tab" value="agency_vendors" />
                    <input
                        type="text"
                        name="av_search"
                        class="search-input"
                    ...
                    />
                    @if ($avSearch)
                        <a href="{{ route('dashboard', ['tab' => 'agency_vendors']) }}" class="btn btn-ghost btn-sm" title="Clear search">✕</a>
                    @endif
        ...
        <div class="table-wrap">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge" style="background:#e5e7eb; color:#374151;">{{ $av->type }}</span>
                        </td>
                        <td>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>
                        @if($avSearch)
                            No records match your search. <a href="{{ route('dashboard', ['tab' => 'agency_vendors']) }}" style="color:var(--info);">Clear search</a>
                        @else
