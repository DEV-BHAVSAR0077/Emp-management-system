<nav class="navbar">
    ...
    <div class="tabs">
        ...
        @endcan
        @can('view-expense')
        <a href="{{ route('dashboard', ['tab' => 'expenses']) }}" class="nav-tab-btn {{ $expensesTabActive ? 'active' : '' }}" id="tab-btn-expenses">
        ...
        @endcan
        @can('view-category')
        <a href="{{ route('dashboard', ['tab' => 'categories']) }}" class="nav-tab-btn {{ $categoriesTabActive ?? false ? 'active' : '' }}" id="tab-btn-categories">
        ...
        <a href="{{ route('dashboard', ['tab' => 'agency_vendors']) }}" class="nav-tab-btn {{ $agencyVendorsTabActive ?? false ? 'active' : '' }}" id="tab-btn-agency-vendors">
